It's interesting test for Planeks
...
directory.
Build an online service for generating CSV files with fake(dummy)
data using Python and Django:

The interface should show a colored label of generation status
